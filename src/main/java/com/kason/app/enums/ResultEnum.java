...
public enum ResultEnum {
    ...
    KNOWLEDGE_CHAPTER_NULL(19,"章节名称不能为空"),
    KNOWLEDGE_DATE_NULL(20,"章节时间不能为空"),
    KNOWLEDGE_ID_NULL(21,"章节ID不能为空"),
    KNOWLEDGE_ERROR(22,"更新章节数据失败"),
    KNOWLEDGE_TYPE_NULL(23,"该章节不存在"),
